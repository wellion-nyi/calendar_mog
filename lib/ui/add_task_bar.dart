...
class AddTextBar extends StatefulWidget {
  const AddTextBar({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              widget: IconButton(
                icon: Icon(Icons.calendar_today_outlined, color: Get.isDarkMode?Colors.white:Colors.grey,),
                onPressed: (){
                    _getDataFromUser();
                },
              ),),
              Row(
                children: [
                  Expanded(child: InputField(
                    ...
                    hint: _startTime,
                    widget: IconButton(
                      icon: Icon(Icons.access_time_outlined, color: Get.isDarkMode?Colors.white:Colors.grey,),
                      onPressed: (){
